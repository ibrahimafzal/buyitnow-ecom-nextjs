...
const UpdateAddress = ({ id, address }) => {
    ...
    const { error, clearErrors, updated, setUpdated, updateAddress, deleteAddress } = useContext(AuthContext)
    ...
    const submitHandler = (e) => {
        ...
        const newAddress = { street, city, phoneNo, state, zipCode, country }
